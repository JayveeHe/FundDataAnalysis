...
if __name__ == '__main__':
    ...
    cPickle.dump(train_datas, open('%s/datas/norm_datas/300_norm_combined_datas.dat' % PROJECT_PATH, 'wb'))
    # load train normalized train datas
    data_process_logger.info('loading datas...')
    train_datas = cPickle.load(open('%s/datas/norm_datas/300_norm_combined_datas.dat' % PROJECT_PATH, 'rb'))
    ...
    train_with_lightgbm(train_datas, output_lightgbm_path, num_boost_round=40000)
